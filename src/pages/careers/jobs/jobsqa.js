            ...
            <Container>
                <div className="header">
                    <div className="container">
                        ...
                        <p> DrugStoc is looking for a <strong>Passionate Procurement Manager</strong> who wants to change the current status quo with healthcare in Sub Saharan Africa. S/he should have proven experience in procurement to help scale to its next stage of growth and expansion. Your central goal is to ensure stock optimization, as well as provide guidance on sourcing and procurement processes. Our procurement manager will be a supply chain expert who will specialize in implementing cost-effective purchases of pharmaceutical products, as required by the company. Ensuring quality control and adhering to the company’s policies and procedures on supply chain management will be some of your main priorities when carrying out this role.
                        </p>
                        <h6>What You Get To Do
                        </h6>
                        <ul>
                            <li>Supplier Management in line with international best practice
                            </li>
                            <li>Organizing pharmaceutical procurement as part of supply chain</li>
                            <li>Building and maintaining long-term relationships with vendors and suppliers</li>
                            <li>Finalizing purchase orders, organizing and confirming delivery of pharmaceutical goods and services.</li>

                        </ul>
                        <h6>What It Takes To Succeed</h6>
                        <ul>
                            <li>A minimum of 4 years' experience in a procurement role in pharma industry.</li>
