...
export const personalized = [
  ...
  },
  {
    ...
    details: 'Discover product alternatives that fit your community’s needs.',
    link,
    icon: <RiCommunityFill size={50} color={color} />,
  },
  {
    title: 'For Hospitals & Clinics',
    details: 'Automate your essential products for top-up services.',
    link,
  ...
  },
  {
    ...
    details: 'Improve patient outcomes and costs with DrugStoc Solutions.',
    link: '/partnerships',
    icon: <RiGovernmentLine size={50} color={color} />,
  },
  {
    title: 'For Health Maintenance Organization (HMO)',
    details: 'Reduce re-admission rates and improve on your service delivery.',
    link: '/partnerships',
...
export const clients = [
  ...
  },
  {
    ...
    role: '',
    message: '“It’s great. Makes ordering of drugs very easy.“',
    image:
  ...
  },
  {
    ...
    role: '',
    message:
      '" Well, for now, I think it\'s still the best wholesale App I  have come across with a friendly stock price.App is Easy to use,It also covers a wider range of available products." ',
  },
  {
    name: 'Lade Hospital',
    role: '',
